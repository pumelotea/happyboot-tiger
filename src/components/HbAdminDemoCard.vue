...
<n-card size="small">
  <template #header-extra>
   <n-space>
     <n-button text @click="showCode = !showCode">
       <n-icon :component="CodeOutline"></n-icon>
     </n-button>
  ...
  <slot/>
  <template #action v-if="showCode">
    <n-tabs type="segment">
      <n-tab-pane name="demo-code" tab="演示代码">
        <n-code :code="props.code" language="xml" :hljs="hljs"></n-code>
      </n-tab-pane>
    </n-tabs>
  </template>
</n-card>
