      ...
      <n-card style="height: 100%;overflow: auto;">
        ...
        <n-form>
          ...
          <n-form-item label="底图预览">
            <img
              ref="HbImage"
              class="hb-preview-img"
            >
          </n-form-item>
          <n-form-item label="">
            <n-input-group v-if="form.image.type === 'link'">
              <n-input v-model:value="form.image.url" />
              <n-button
                type="primary"
                @click="imageLoad"
              >
          ...
          <n-form-item label="底图图片宽高">
            <n-input-group>
              ...
              <n-input-number
                v-model:value="form.image.width"
                :show-button="false"
              />
              ...
              <n-input-number
                v-model:value="form.image.height"
                :show-button="false"
              />
              <n-input-group-label>px</n-input-group-label>
            </n-input-group>
          ...
          <n-form-item label="">
            <n-input-group v-if="form.sign.type === 'link'">
              <n-input v-model:value="form.sign.url" />
              <n-button
                type="primary"
                @click="signLoad"
              >
            ...
            <template v-if="form.sign.type === 'upload'">
              ...
              >
              <n-button
                v-if="form.sign.type === 'upload'"
                type="primary"
                @click="chooseSignFile"
              >
                <n-icon
                  :component="CloudUploadOutline"
                  size="22"
          ...
          <n-form-item label="水印图片宽高">
            <n-input-group>
              ...
              <n-input-group-label>高度</n-input-group-label>
              <n-input-number
                v-model:value="form.sign.height"
                :show-button="false"
              />
              <n-input-group-label>px</n-input-group-label>
            </n-input-group>
          ...
          <n-form-item label="水印位置">
            <n-radio-group v-model:value="form.sign.position">
              <n-space>
                <n-radio value="leftTop">
                  左上角
                </n-radio>
                <n-radio value="leftBottom">
                  左下角
                </n-radio>
                <n-radio value="rightTop">
                  右上角
                </n-radio>
                <n-radio value="rightBottom">
                  右下角
                </n-radio>
          ...
          <n-form-item
            v-if="form.sign.position === 'free'"
            label="水印位置参数"
          >
            <n-input-group>
              <n-input-group-label>距左</n-input-group-label>
              <n-input-number
                v-model:value="form.sign.left"
                :show-button="false"
              />
              <n-input-group-label>px</n-input-group-label>
              <div style="display: flex;align-items: center;padding:0 10px;">
