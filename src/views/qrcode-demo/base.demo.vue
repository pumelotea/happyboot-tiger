            ...
            <n-form>
              ...
              <n-form-item label="图像类型">
                <n-radio-group v-model:value="model.type">
                  <n-space>
                    <n-radio value="image/jpeg">
                      image/jpeg
                    </n-radio>
                    <n-radio value="image/png">
                      image/png
                    </n-radio>
                  </n-space>
                </n-radio-group>
            ...
            <n-form>
              <n-form-item label="logo（请选择尺寸小一些的图片）">
                <n-input-group style="width: 100%">
                  <n-input v-model:value="model.logoUrl" />
                  <input
                    ref="fileInput"
                    type="file"
                    style="display: none"
              ...
              <n-form-item label="logo边距">
                <n-slider
                  v-model:value="model.logoBorderSize"
                  :min="0"
                  :max="100"
                  :step="1"
                />
          ...
          >
            <n-form>
              <n-form-item label="底部文案">
                <n-input v-model:value="model.bottomText" />
              </n-form-item>
              <n-form-item label="底部文案字体大小">
                <n-slider
                  v-model:value="model.bottomFontSize"
                  :min="0"
                  :max="50"
                  :step="1"
                />
              ...
              <n-form-item label="底部文案距离二维码距离">
                <n-slider
                  v-model:value="model.bottomTextTopMargin"
                  :min="0"
                  :max="100"
                  :step="1"
                />
              ...
              <n-form-item label="底部文案距离二维码距离">
                <n-slider
                  v-model:value="model.bottomTextBottomMargin"
                  :min="0"
                  :max="100"
                  :step="1"
                />
