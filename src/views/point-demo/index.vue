<script setup>
import {NLayout ,NLayoutHeader,NLayoutContent,NPageHeader,NCode,NButton,NSpace} from 'naive-ui';
  ...
  <hb-admin-page-layout>
    <n-layout style="padding:20px">
      <n-layout-content>
        ...
        <h4>Vue模板中使用`v-point`，路由节点中的`permissionKey`属性和指令中配置的值相同，则显示，否则不显示<br/>如以下代码</h4>
        <n-code :code="htmlCode" language="xml" :hljs="hljs"></n-code>
        <h4>权限点配置在路由节点的子节点中，<br/>如以下代码</h4>
